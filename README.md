[![Build Status](https://dev.azure.com/devops-by-ajay/demo4/_apis/build/status/ajaykumarnila.ContosoAir?branchName=master)](https://dev.azure.com/devops-by-ajay/demo4/_build/latest?definitionId=7&branchName=master)
# This project is retired, archived, and no longer supported. You are welcome to continue to use and fork the repository.


# Microsoft.Github CI Demo

## Made package name to *.zip in release pipeline
